...
**Duración:** 40 horas  
**Carácter:** Integrador  
**Carácter evaluativo:** Individual  
**Módulos implicados:**  
- **PROG** – Programación  
...
- **EDE** – Entornos de Desarrollo  

---

## 🎯 Finalidad del módulo
El módulo de **Proyecto Intermodular** tiene como finalidad integrar los aprendizajes adquiridos en los módulos técnicos del ciclo formativo, a través del desarrollo de un **proyecto web completo** que abarque desde el análisis, diseño y programación hasta el despliegue y la documentación profesional del producto.

El proyecto debe evidenciar la **autonomía técnica**, la **planificación efectiva**, el **trabajo colaborativo** y la **calidad profesional** en todas las fases del ciclo de vida de una aplicación web.
...
1. **Definición y planificación del proyecto**
   - Identificación del problema, objetivos y alcance.  
   - Análisis de requisitos y recursos.  
   - Cronograma, roles y herramientas de gestión (Trello, GitHub Projects).

2. **Diseño técnico y estructural**
   - Arquitectura cliente-servidor.  
   - Modelado de datos (E/R, normalización, SQL).  
   - Diseño de interfaz y experiencia de usuario.  

3. **Desarrollo de la aplicación**
   - Backend: rutas, controladores, APIs, autenticación, sesiones.  
   - Frontend: manipulación del DOM, validaciones, integración con API.  
   - Lenguajes de marcas y hojas de estilo.  
   - Control de versiones y trabajo colaborativo.  

4. **Pruebas y despliegue**
   - Pruebas unitarias, funcionales y de integración.  
   - Despliegue en entornos reales o cloud.  
   - Seguridad, rendimiento y optimización.  

5. **Documentación y presentación**
   - Memoria técnica.  
   - Manual de instalación y usuario.  
   - Defensa y exposición técnica.  
...
|----------------|----------------------|-------------------------|--------------|
| **Análisis del sector y necesidades (RA1)** | Identifica correctamente las necesidades del sector productivo y justifica el tipo de proyecto web requerido. | PROG, LMSGI, SI, BBDD, DWES, DWEC, DIW, DAW, EDE | 10% |
...
| **Planificación de la ejecución (RA3)** | Planifica la ejecución secuenciando actividades, recursos, riesgos y documentación asociada. | PROG, DWES, DWEC, BBDD, DIW, EDE, DAW, SI | 20% |
| **Control y seguimiento (RA4)** | Define procedimientos de seguimiento, indicadores de calidad y sistemas de evaluación continua. | EDE, PROG, DWES, DWEC, BBDD, DIW, DAW, SI | 40% |
