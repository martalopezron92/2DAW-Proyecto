...
- **Metodología ABP (Aprendizaje Basado en Proyectos):** desarrollo de un proyecto real o simulado integrando los módulos técnicos.  
- **Evaluación continua:** seguimiento por entregas parciales (análisis, diseño, desarrollo, pruebas, defensa).  
- **Trabajo colaborativo:** uso de GitHub Classroom, Trello, Google Workspace, etc.  
- **Tutorías técnicas:** revisión de hitos y asesoramiento por parte del profesorado de cada módulo.  
